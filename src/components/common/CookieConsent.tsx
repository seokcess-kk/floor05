...
// AdSense 스크립트(adsbygoogle.js)는 루트 layout의 <head>에서 공식 스니펫으로
// 로드한다(심사 시스템이 초기 HTML에서 확인). 이 컴포넌트는 동의 배너 표시와
// 개인화 여부(NPA) 플래그 제어만 담당한다.
 ...
 * - 다른 탭에서의 변경도 감지
 */
export function useCookieConsent(): { consented: boolean } {
