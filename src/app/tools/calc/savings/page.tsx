...
export const metadata: Metadata = {
  ...
  description:
    "예금·적금의 만기 수령액과 이자를 단리·복리로 계산합니다. 이자소득세 15.4%를 뗀 세후 금액까지. 무료이고, 내 목돈 규모는 아무 데도 남지 않습니다.",
  keywords: [
    "예금 적금 이자 계산기",
    "적금 이자 계산",
    "예금 이자 계산",
  ...
  sections: [
    ...
    },
    {
      ...
      table: {
        ...
        caption:
          "이자소득세율 15.4%는 계산 엔진 상수와 동일. 월이율=연이율÷12. 갱신 2026-07.",
      },
      paragraphs: [
...
const faqs = [
  ...
  {
    question: "월 10만원씩 1년 붓는 연 4% 적금, 이자가 왜 4만원이 안 되나요?",
    answer:
      "원금 합계(120만원)에 4%를 곱한 4만 8천원을 떠올리기 쉽지만, 적금은 매달 넣은 돈마다 만기까지 남은 기간이 달라 마지막 달 납입금은 한 달치 이자만 붙습니다. 세전 이자는 월납입 × 월이율 × (개월×(개월+1)÷2)로 계산돼 이 경우 약 2만 6천원이고, 여기서 이자소득세 15.4%까지 떼면 손에 쥐는 이자는 더 줄어듭니다. 원금 전체에 표면금리를 곱해 보여주는 방식은 이 구조를 놓쳐 이자를 실제보다 부풀릴 수 있습니다.",
  },
  {
    question: "입력한 값이 저장되나요?",
    answer:
      "아니요. 예치금과 월 납입액은 브라우저 안에서 계산될 뿐 어디에도 기록되지 않습니다. 이 도구는 계산만 하고 잔고는 궁금해하지 않습니다.",
  },
];
