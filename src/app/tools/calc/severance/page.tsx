...
const faqs = [
  ...
  {
    question: "'월급 × 근속연수'로 어림한 값과 결과가 다른 이유는?",
    answer:
      "법정 평균임금은 기본급만이 아니라 정기 상여금과 연차수당까지 3개월분(각각 연간 총액의 3/12)을 임금총액에 더해 산정합니다. 예를 들어 월급 300만원에 지난 1년 상여 480만원, 연차수당 60만원을 받았다면 상여·연차 가산분 약 135만원이 3개월 임금총액에 더해져 1일 평균임금이 올라갑니다. 상여·연차를 빼고 월급만으로 어림하면 이 부분이 빠져 실제보다 적게 나올 수 있어, 이 도구는 두 항목을 함께 반영합니다.",
  },
  {
  ...
  sections: [
    ...
    },
    {
      ...
      table: {
        ...
        caption:
          "30일분·365일 기준 등 산정 상수는 계산 엔진 상수와 동일. 표시 금액은 모두 세전. 기준 시점 2026-07.",
      },
      paragraphs: [
