...
export const metadata: Metadata = {
  ...
  description:
    "목표일까지 며칠 남았는지(D-Day), 시작일부터 며칠 지났는지(100일·200일·1000일·주년)를 바로 계산합니다. 시험·전역·커플 기념일까지. 날짜 계산은 브라우저가 그 자리에서 끝냅니다.",
  keywords: [
    "디데이 계산기",
    "D-Day 계산기",
    "날짜 계산기",
  ...
  sections: [
    {
      ...
      table: {
        headers: ["군별", "복무기간", "입대일 2026-01-02 → 만기전역일"],
        rows: [
          ["육군·해병대", "18개월", "2027-07-01"],
          ["해군", "20개월", "2027-09-01"],
          ["공군", "21개월", "2027-10-01"],
          ["사회복무요원", "21개월", "2027-10-01"],
        ],
        caption:
          "입대일을 복무 첫날로 세어 계산하며, 위 전역일은 예시입니다. 실제 전역 예정일은 병무청·나라사랑포털에서 확인한 뒤, 그 날짜를 위 계산기의 목표일로 넣으면 남은 D-Day가 바로 나옵니다.",
      },
    },
    {
      ...
      table: {
        headers: ["기념일", "계산", "메모"],
        rows: [
          ["1일", "시작일 당일", "커플은 사귄 첫날, 아기는 태어난 날"],
          ["22일", "시작일 + 21일", "이른바 '투투'"],
          ["100일", "시작일 + 99일", "아기 백일도 같은 방식"],
          ["200일", "시작일 + 199일", "-"],
          ["1,000일", "시작일 + 999일", "약 2년 9개월 뒤"],
          ["1주년(돌)", "시작일의 1년 뒤 같은 날짜", "'365일째'와 하루 어긋날 수 있음"],
        ],
        caption:
          "시작일을 1일째로 세는 한국식 계산이라 100일째는 시작일보다 99일 늦습니다. 1주년은 달력상 같은 날짜여서 365일째와 하루 차이가 날 수 있는데, 위 계산기는 두 기준을 모두 날짜로 짚어 줍니다.",
      },
    },
    {
      heading: "백일·돌·1000일을 미리 챙기기",
      paragraphs: [
        "아기 백일은 출생일을 시작일(1일째)로 넣으면 100일째 날짜가 바로 나옵니다. 돌은 1주년으로 표시됩니다. 커플이라면 1000일, 결혼이라면 매년 주년 날짜를 미리 확인해 두기 좋습니다. 기념일·목표일 날짜는 이 기기에서 D-Day를 따져 볼 때만 쓰이고 외부로 나가지 않습니다.",
      ],
    },
  ],
};
...
const faqs = [
  ...
  {
    question: "입력한 기념일 날짜는 기록에 남나요?",
    answer:
      "백일, 전역일, 기념일처럼 목표일로 넣은 날짜는 지금 열어 둔 화면에서 D-Day를 계산하는 데만 사용됩니다. 서버에 보내지 않으며, 별도로 보관하지도 않습니다.",
  },
];
