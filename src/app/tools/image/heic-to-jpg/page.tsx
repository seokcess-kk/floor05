...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "기본값 90%면 대부분 그대로 써도 됩니다. 눈으로는 원본과 가려내기 어렵고, 파일을 더 줄여야 하면 품질 슬라이더를 조금 내리면 됩니다. 반대로 100% 가까이 올리면 용량은 늘지만 원본에 최대한 붙습니다.",
  },
  {
    question: "아이폰 앨범에서 여러 장을 골라 한꺼번에 바꿀 수 있나요?",
    answer:
      "네. 데스크톱은 사진 10장, 모바일은 5장까지 한 번에 받습니다. 아이폰에서 막 옮겨 온 사진 뭉치를 통째로 올려 JPG로 바꾸고, 결과는 ZIP 하나로 정리해 받으면 됩니다.",
  },
  {
...
const guide = {
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        "HEIC는 영상 코덱 HEVC를 정지 사진에 끌어다 쓴 포맷이라, 애플 기기끼리는 잘 통해도 그 울타리 밖으로 나가면 이야기가 달라집니다. JPG는 반대로 낡았다 싶을 만큼 오래됐지만, 그래서 오히려 안 열리는 곳을 찾기가 더 어렵습니다. HEIC를 JPG로 한 번 바꿔 두면 '이 사진 왜 안 열려' 하는 순간을 대체로 건너뛸 수 있습니다. 이 도구는 품질을 90%로 잡아 두었는데, 아이폰 원본과 나란히 두고 봐도 차이를 짚어내기 어려운 선입니다. 더 가볍게 하고 싶으면 슬라이더를 내리고, 사진이 여러 장이면 한꺼번에 올려 묶음으로 받으면 됩니다.",
