...
const faqs = [
  {
    ...
    answer:
      "거의 그대로입니다. JPG는 품질 95%로 다시 저장해 차이를 눈으로 알아채기 어렵고, PNG는 무손실이라 화질이 유지됩니다.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "플랫폼마다 처리 방식이 달라 장담할 수 없습니다. 자동으로 떼 주는 곳도 있지만, 카톡 원본 전송이나 메일 첨부처럼 파일을 그대로 넘기는 경로에서는 위치정보가 딸려갑니다. 여기서 먼저 지워 두면 어디로 보내든 신경 쓸 일이 없습니다.",
  },
  {
