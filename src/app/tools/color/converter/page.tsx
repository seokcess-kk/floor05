  ...
  sections: [
    {
      ...
      table: {
        headers: ["표기법", "형식", "값 범위", "주 사용처"],
        rows: [
          ["HEX", "#RRGGBB", "각 채널 00~FF (16진수)", "웹·CSS·디자인 툴"],
          ["RGB", "rgb(r, g, b)", "각 채널 0~255", "화면 출력·코드·rgba 투명도"],
          ["HSL", "hsl(h, s%, l%)", "H 0~360 · S·L 0~100%", "색 미세 조정·팔레트 생성"],
          ["CMYK", "c, m, y, k", "각 0~100%", "인쇄(감산 혼합)"],
        ],
        caption:
          "웹은 HEX·RGB, 인쇄는 CMYK, 색을 굴려 볼 때는 HSL이 편합니다. CMYK는 화면색을 감산 혼합으로 근사한 값이라 실제 인쇄 결과와는 차이가 납니다.",
      },
    },
    {
      heading: "양방향 변환과 복사",
    ...
    {
      heading: "자주 쓰는 CSS 명명색",
      paragraphs: [
        "CSS는 색을 코드 대신 이름으로도 받습니다. black·white처럼 뻔한 것 말고도 tomato나 dodgerblue 같은 이름이 표준에 들어 있어, 급하게 시안을 잡을 때 요긴합니다. 다만 이름은 148개로 정해져 있어, 브랜드 색처럼 미묘한 값은 결국 HEX나 RGB로 적어야 합니다.",
      ],
      table: {
        headers: ["CSS 이름", "HEX", "RGB"],
        rows: [
        ...
        caption:
          "표준 CSS 색 이름 일부. 이름을 HEX·RGB로 바꿔 두면 디자인 툴이나 CMYK 인쇄 시안으로 옮기기 쉽습니다. rebeccapurple은 CSS 명세에 헌정된 이름으로, 실제로 동작하는 정식 색입니다.",
      },
    },
  ],
};
