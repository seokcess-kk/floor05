...
const guide = {
  ...
  sections: [
    ...
    {
      heading: "같은 전용면적도 전용률에 따라 다른 평형으로 불린다",
      paragraphs: [
        "분양 광고의 '몇 평형'은 전용면적이 아니라 공급면적(전용면적＋주거 공용)을 평으로 환산한 값입니다. 전용면적을 공급면적으로 나눈 비율이 전용률인데, 아파트는 대개 70%대, 오피스텔은 50%대여서 같은 전용면적이라도 붙는 평형 호칭이 달라집니다.",
      ],
      table: {
        headers: ["전용면적", "예상 공급면적", "분양 호칭", "전용률(예시)"],
        rows: [
          ["아파트 전용 59㎡", "약 80㎡", "24평형", "약 74%"],
          ["아파트 전용 84㎡", "약 113㎡", "34평형", "약 74%"],
          ["아파트 전용 114㎡", "약 150㎡", "45평형", "약 76%"],
          ["오피스텔 전용 45㎡", "약 82㎡", "25평형", "약 55%"],
          ["오피스텔 전용 60㎡", "약 109㎡", "33평형", "약 55%"],
        ],
        caption:
          "전용률과 공급면적은 단지·건물마다 달라 위 값은 예시입니다. 전용률 = 전용면적 ÷ 공급면적이며, 계약면적은 여기에 주차장·기계실 같은 기타 공용까지 얹은 더 넓은 값입니다. 오피스텔은 계약면적 기준으로 광고하는 경우가 많아 같은 평형이라도 실사용 면적이 더 좁게 느껴집니다.",
      },
    },
    {
      heading: "토지·상가에도 그대로",
