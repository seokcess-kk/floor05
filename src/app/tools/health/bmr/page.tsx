...
const guide = {
  ...
  sections: [
    ...
    {
      heading: "어떤 공식·기준으로 계산하나",
      table: {
        headers: ["목표", "하루 칼로리", "예상 체중 변화(1주)"],
        rows: [
        ...
        caption:
          "체지방 1kg ≈ 7,700kcal 기준. 하루 500kcal를 덜 쓰면 한 주에 약 3,500kcal, 곧 0.5kg 안팎이 빠지는 셈입니다. 증량 칼로리(+400)는 이 도구가 적용한 하루 조정폭입니다.",
      },
      paragraphs: [
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "아니요. 성별·나이·키·몸무게 같은 몸 정보는 브라우저에서 기초대사량을 구하는 동안만 쓰이며, 서버로 넘어가거나 저장되지 않습니다.",
  },
];
