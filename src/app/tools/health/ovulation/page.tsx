...
export const metadata: Metadata = {
  ...
  description:
    "마지막 생리 시작일과 평균 주기만 넣으면 배란 예정일, 가임기, 다음 생리 예정일을 바로 계산합니다. 향후 3개 주기까지. 민감한 정보인 만큼 입력은 기기 밖으로 나가지 않습니다.",
  keywords: [
    "배란일 계산기",
    "가임기 계산기",
    "배란일 계산",
...
const guide = {
  ...
  sections: [
    ...
    {
      heading: "예측 근거와 안전 안내",
      table: {
        headers: ["항목", "이 도구의 가정", "근거"],
        rows: [
          ["배란일", "다음 생리 예정일 − 14일", "황체기 평균 14일 고정"],
          ["가임기 시작", "배란 5일 전", "정자 생존 최대 약 5일"],
          ["가임기 종료", "배란 1일 후", "난자 수명 약 12~24시간"],
        ],
        caption:
          "황체기 14일은 개인차가 있는 평균값입니다. 실제 배란은 이 계산보다 며칠 앞뒤로 움직일 수 있습니다.",
      },
      paragraphs: [
        "이 예측은 '황체기(배란부터 다음 생리까지)가 늘 14일'이라는 한 가지 가정 위에 서 있습니다. 실제 황체기는 사람에 따라 11~17일까지 벌어질 수 있어, 주기 길이가 같아도 배란일은 개인마다 다르게 나올 수 있습니다.",
        "그래서 이 결과 하나로 피임 여부를 정하는 것은 위험합니다. 이른바 날짜 피임법은 실패율이 높다고 알려져 있으니, 확실한 피임이나 난임·임신 계획은 산부인과 진료로 정하시길 권합니다.",
        "생리 주기는 예민한 개인정보입니다. 입력한 날짜와 주기는 지금 보는 기기 화면 안에서만 계산에 쓰이고, 어느 서버로도 올라가지 않습니다.",
      ],
    },
  ],
};
