    ...
    <>
      ...
      <main className="mx-auto max-w-3xl px-4 py-10 sm:px-6 lg:px-8">
        ...
        <article className="prose prose-gray max-w-none">
          ...
          <h2 className="text-2xl font-bold text-brand-black mt-12 mb-4">배란일은 어떻게 계산할까요?</h2>
          ...
          <h2 className="text-2xl font-bold text-brand-black mt-12 mb-4">가임기는 어느 기간을 말할까요?</h2>
          <p className="text-brand-mid leading-relaxed mb-4">
          ...
          <h2 className="text-2xl font-bold text-brand-black mt-12 mb-4">주기 길이에 따라 날짜는 어떻게 달라질까요?</h2>
          <p className="text-brand-mid leading-relaxed mb-4">
            ...
            <table className="w-full text-sm border-collapse">
              <thead>
                <tr className="border-b border-brand-light/40 text-left">
                  <th className="py-2 pr-4 text-brand-black">평균 생리 주기</th>
                  <th className="py-2 pr-4 text-brand-black">배란 예정일</th>
                  <th className="py-2 pr-4 text-brand-black">가임기 추정 범위</th>
                  <th className="py-2 pr-4 text-brand-black">계산 방식</th>
                </tr>
              </thead>
              <tbody className="text-brand-mid">
                <tr className="border-b border-brand-light/20">
                  <td className="py-2 pr-4">26일</td>
                  <td className="py-2 pr-4">D+12</td>
                  <td className="py-2 pr-4">D+7 ~ D+13</td>
                  <td className="py-2 pr-4">다음 생리 D+26에서 14일 전</td>
                </tr>
                <tr className="border-b border-brand-light/20">
                  <td className="py-2 pr-4">28일</td>
                  <td className="py-2 pr-4">D+14</td>
                  <td className="py-2 pr-4">D+9 ~ D+15</td>
                  <td className="py-2 pr-4">다음 생리 D+28에서 14일 전</td>
                </tr>
                <tr className="border-b border-brand-light/20">
                  <td className="py-2 pr-4">30일</td>
                  <td className="py-2 pr-4">D+16</td>
                  <td className="py-2 pr-4">D+11 ~ D+17</td>
                  <td className="py-2 pr-4">다음 생리 D+30에서 14일 전</td>
                </tr>
                <tr>
                  <td className="py-2 pr-4">32일</td>
                  <td className="py-2 pr-4">D+18</td>
                  <td className="py-2 pr-4">D+13 ~ D+19</td>
                  <td className="py-2 pr-4">다음 생리 D+32에서 14일 전</td>
                </tr>
              </tbody>
            </table>
          </div>
          ...
          <h2 className="text-2xl font-bold text-brand-black mt-12 mb-4">계산값의 한계는 무엇일까요?</h2>
          <p className="text-brand-mid leading-relaxed mb-4">
          ...
          <h2 className="text-2xl font-bold text-brand-black mt-12 mb-4">정확도를 높이려면 무엇을 함께 볼까요?</h2>
          <p className="text-brand-mid leading-relaxed mb-4">
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm border-collapse">
              <thead>
                <tr className="border-b border-brand-light/40 text-left">
                  <th className="py-2 pr-4 text-brand-black">확인 방법</th>
                  <th className="py-2 pr-4 text-brand-black">도움이 되는 점</th>
                  <th className="py-2 pr-4 text-brand-black">주의할 점</th>
                </tr>
              </thead>
              <tbody className="text-brand-mid">
                <tr className="border-b border-brand-light/20">
                  <td className="py-2 pr-4">날짜 계산</td>
                  <td className="py-2 pr-4">최근 주기를 바탕으로 예상 범위를 빠르게 잡음</td>
                  <td className="py-2 pr-4">불규칙 주기에서는 오차가 커질 수 있음</td>
                </tr>
                <tr className="border-b border-brand-light/20">
                  <td className="py-2 pr-4">기초체온법</td>
                  <td className="py-2 pr-4">여러 주기의 체온 변화를 기록해 흐름을 봄</td>
                  <td className="py-2 pr-4">수면, 측정 시간, 컨디션 영향을 받을 수 있음</td>
                </tr>
                <tr>
                  <td className="py-2 pr-4">배란테스트기</td>
                  <td className="py-2 pr-4">배란 전후 호르몬 변화를 참고함</td>
                  <td className="py-2 pr-4">제품 사용법과 개인 상태에 따라 해석이 달라질 수 있음</td>
                </tr>
              </tbody>
            </table>
          </div>

          <h2 className="text-2xl font-bold text-brand-black mt-12 mb-4">임신 주수와 출산예정일은 어떻게 이어질까요?</h2>
          <p className="text-brand-mid leading-relaxed mb-4">
          ...
          <h3 className="text-xl font-semibold text-brand-black mt-8 mb-3">배란 예정일은 어떤 공식으로 구하나요?</h3>
          <p className="text-brand-mid leading-relaxed mb-4">
            다음 생리 예정일에서 14일을 빼 배란 예정일을 추정합니다. 황체기가 약 14일이라는
            평균 가정을 쓰는 방법입니다.
          </p>
          <h3 className="text-xl font-semibold text-brand-black mt-8 mb-3">가임기는 며칠로 보나요?</h3>
          <p className="text-brand-mid leading-relaxed mb-4">
            일반적으로 배란일 5일 전부터 배란일 1일 후까지로 봅니다. 정자와 난자의 생존 기간을
            반영한 참고 범위입니다.
          </p>
          <h3 className="text-xl font-semibold text-brand-black mt-8 mb-3">생리 주기가 불규칙하면 계산을 믿어도 되나요?</h3>
          <p className="text-brand-mid leading-relaxed mb-4">
            불규칙한 주기에서는 오차가 커질 수 있습니다. 여러 주기 기록, 기초체온, 배란테스트기
            등을 함께 보되 의학적 판단은 진료를 통해 확인하는 것이 좋습니다.
          </p>
          <h3 className="text-xl font-semibold text-brand-black mt-8 mb-3">배란일 계산을 피임에 써도 되나요?</h3>
          <p className="text-brand-mid leading-relaxed mb-4">
