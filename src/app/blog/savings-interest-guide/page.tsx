    ...
    <>
      ...
      <main className="mx-auto max-w-3xl px-4 py-10">
        ...
        <div className="prose prose-gray max-w-none">
          <p>예금과 적금 이자는 같은 금리라도 납입 방식 때문에 다르게 계산됩니다. 예금은 처음 넣은 목돈 전체가 기간 내내 이자를 받지만, 적금은 매달 납입한 금액이 만기까지 남은 개월 수만큼만 이자를 받습니다.</p>
          ...
          <h2>예금과 적금은 왜 이자가 다르게 보이나요?</h2>
          <p>예금은 목돈이 한 번에 들어가고 적금은 원금이 나누어 들어가기 때문에 이자가 다르게 보입니다. 예를 들어 연 600만원을 굴린다고 해도 1월에 600만원을 예금으로 넣는 경우와 매달 50만원씩 12번 넣는 경우는 돈이 머문 시간이 다릅니다. 금리는 같아도 실제 이자가 붙는 원금의 기간이 다르므로 결과가 달라집니다.</p>
          <p>적금의 표면금리가 높아 보여도 만기 이자가 기대보다 작게 느껴지는 이유가 여기에 있습니다. 첫 달 납입금은 12개월 동안 이자를 받지만 마지막 달 납입금은 1개월치 이자만 받습니다. 그래서 적금 이자는 매달 납입한 돈을 각각 다른 기간으로 나누어 계산한 값을 더한 구조입니다.</p>
          <div className="overflow-x-auto"><table><thead><tr><th>구분</th><th>납입 방식</th><th>이자가 붙는 방식</th><th>같은 연 4% 단리 예시</th></tr></thead><tbody><tr><td>예금</td><td>1,200만원을 한 번에 예치</td><td>원금 전체가 12개월 적용</td><td>세전이자 480,000원</td></tr><tr><td>적금</td><td>월 50만원씩 12개월 납입</td><td>회차별 남은 개월 수만 적용</td><td>세전이자 130,000원</td></tr></tbody></table></div>
          <h2>단리 이자는 어떻게 계산하나요?</h2>
          <p>단리는 원금에 약정 금리와 기간을 곱해 계산합니다. 예금 단리 이자는 원금 × 연이율 × (개월/12)입니다. 1,200만원을 12개월 동안 연 4% 단리로 맡기면 세전이자는 480,000원이고, 이자소득세 15.4%인 73,920원을 뺀 세후이자는 406,080원입니다.</p>
          <p>적금 단리는 월납입액 × 월이율 × (개월 × (개월+1) ÷ 2)로 계산할 수 있습니다. 월 50만원을 12개월 동안 연 4%로 납입하면 원금은 6,000,000원, 세전이자는 130,000원, 세금은 20,020원, 세후이자는 109,980원입니다. 각 회차 돈이 예치된 기간을 모두 합산한 결과입니다.</p>
          <h2>월복리는 단리보다 얼마나 달라지나요?</h2>
          ...
          <h2>상품을 비교할 때는 어떤 순서로 보면 되나요?</h2>
          <p>상품 비교는 납입 방식, 금리 유형, 세후 금액 순서로 보는 것이 좋습니다. 먼저 목돈을 한 번에 넣을 수 있는지, 매달 쌓아 가야 하는지를 정하면 예금과 적금 선택지가 나뉩니다. 그다음 단리인지 월복리인지 확인하고, 마지막으로 세금이 빠진 뒤 실제 수령액을 비교해야 숫자를 비슷한 기준에 놓을 수 있습니다.</p>
          <p>금리만 보고 결론을 내리면 조건 차이를 놓치기 쉽습니다. 우대금리 조건, 납입 가능 기간, 중도해지 시 적용 금리, 세금 적용 방식은 상품마다 달라질 수 있습니다. 계산식은 후보를 빠르게 좁히는 도구로 쓰고, 실제 가입 전에는 상품 설명서의 적용 조건을 함께 확인하는 편이 안정적입니다.</p>
          <h2>FAQ</h2>
          <section><h3>예금과 적금은 같은 금리여도 이자가 같나요?</h3><p>같지 않습니다. 예금은 목돈 전체가 처음부터 이자를 받고, 적금은 매달 납입한 돈이 남은 기간만큼만 이자를 받습니다.</p></section>
          <section><h3>단리와 월복리는 무엇이 다른가요?</h3><p>단리는 원금 기준으로 계산하고, 월복리는 매월 붙은 이자가 다음 계산에 포함됩니다. 기간이 길수록 차이가 커질 수 있습니다.</p></section>
          <section><h3>이자소득세 15.4%는 언제 빠지나요?</h3><p>일반 과세 상품에서는 이자가 지급될 때 원천징수됩니다. 소득세 14%와 지방소득세 1.4%를 합한 비율입니다.</p></section>
          <section><h3>비과세 상품은 세후이자가 다르게 나오나요?</h3><p>상품 조건과 가입 자격에 따라 달라질 수 있습니다. 세후 비교를 할 때는 해당 상품의 과세 조건을 함께 확인해야 합니다.</p></section>
        </div>
