    ...
    <>
      ...
      <main className="mx-auto max-w-3xl px-4 py-10 sm:px-6 lg:px-8">
        ...
        <article className="prose prose-gray max-w-none">
          ...
          <h2 className="text-2xl font-bold text-brand-black mt-12 mb-4">대출 이자는 무엇으로 달라질까요?</h2>
          ...
          <h2 className="text-2xl font-bold text-brand-black mt-12 mb-4">원리금균등상환은 어떻게 계산할까요?</h2>
          <p className="text-brand-mid leading-relaxed mb-4">
          ...
          <h2 className="text-2xl font-bold text-brand-black mt-12 mb-4">원금균등상환은 왜 초반 부담이 클까요?</h2>
          <p className="text-brand-mid leading-relaxed mb-4">
          ...
          <h2 className="text-2xl font-bold text-brand-black mt-12 mb-4">만기일시상환은 어떤 구조일까요?</h2>
          <p className="text-brand-mid leading-relaxed mb-4">
          ...
          <h2 className="text-2xl font-bold text-brand-black mt-12 mb-4">1억 원을 30년 빌리면 얼마나 차이날까요?</h2>
          <p className="text-brand-mid leading-relaxed mb-4">
            ...
            <table className="w-full text-sm border-collapse">
              <thead>
                <tr className="border-b border-brand-light/40 text-left">
                  <th className="py-2 pr-4 text-brand-black">상환 방식</th>
                  <th className="py-2 pr-4 text-brand-black">월 상환액</th>
                  <th className="py-2 pr-4 text-brand-black">총이자</th>
                  <th className="py-2 pr-4 text-brand-black">특징</th>
                </tr>
              </thead>
              <tbody className="text-brand-mid">
                <tr className="border-b border-brand-light/20">
                  <td className="py-2 pr-4">원리금균등</td>
                  <td className="py-2 pr-4">월 477,415원</td>
                  <td className="py-2 pr-4">약 7,187만원</td>
                  <td className="py-2 pr-4">매월 납입액이 같고 초반 이자 비중이 큼</td>
                </tr>
                <tr className="border-b border-brand-light/20">
                  <td className="py-2 pr-4">원금균등</td>
                  <td className="py-2 pr-4">첫 달 611,111원, 마지막 달 278,704원</td>
                  <td className="py-2 pr-4">약 6,017만원</td>
                  <td className="py-2 pr-4">총이자는 적지만 초기 납입액이 높음</td>
                </tr>
                <tr className="border-b border-brand-light/20">
                  <td className="py-2 pr-4">만기일시</td>
                  <td className="py-2 pr-4">매월 333,333원</td>
                  <td className="py-2 pr-4">1억 2,000만원</td>
                  <td className="py-2 pr-4">매월 이자만 내고 만기에 원금을 상환</td>
                </tr>
              </tbody>
            </table>
          </div>
          ...
          <h2 className="text-2xl font-bold text-brand-black mt-12 mb-4">신용대출 3천만 원은 어떤 차이가 날까요?</h2>
          <p className="text-brand-mid leading-relaxed mb-4">
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm border-collapse">
              <thead>
                <tr className="border-b border-brand-light/40 text-left">
                  <th className="py-2 pr-4 text-brand-black">조건</th>
                  <th className="py-2 pr-4 text-brand-black">원리금균등</th>
                  <th className="py-2 pr-4 text-brand-black">원금균등</th>
                  <th className="py-2 pr-4 text-brand-black">만기일시</th>
                </tr>
              </thead>
              <tbody className="text-brand-mid">
                <tr className="border-b border-brand-light/20">
                  <td className="py-2 pr-4">주택담보 1억원, 연 4%, 30년</td>
                  <td className="py-2 pr-4">월 477,415원, 총이자 약 7,187만원</td>
                  <td className="py-2 pr-4">첫 달 611,111원, 총이자 약 6,017만원</td>
                  <td className="py-2 pr-4">월 333,333원, 총이자 1억 2,000만원</td>
                </tr>
                <tr className="border-b border-brand-light/20">
                  <td className="py-2 pr-4">신용대출 3,000만원, 연 5%, 3년</td>
                  <td className="py-2 pr-4">월 899,127원, 총이자 2,368,569원</td>
                  <td className="py-2 pr-4">첫 달 958,333원, 총이자 2,312,500원</td>
                  <td className="py-2 pr-4">월 125,000원, 총이자 4,500,000원</td>
                </tr>
              </tbody>
            </table>
          </div>

          <h2 className="text-2xl font-bold text-brand-black mt-12 mb-4">어떤 상환 방식이 더 유리할까요?</h2>
          <p className="text-brand-mid leading-relaxed mb-4">
          ...
          <h2 className="text-2xl font-bold text-brand-black mt-12 mb-4">자주 묻는 질문</h2>
          <h3 className="text-xl font-semibold text-brand-black mt-8 mb-3">대출 이자는 어떤 값으로 계산하나요?</h3>
          <p className="text-brand-mid leading-relaxed mb-4">
            대출 이자는 원금, 연 이율, 상환 기간, 상환 방식으로 계산합니다. 같은 금리와 기간이어도
            원금을 줄이는 속도가 다르면 월 납입액과 총이자가 달라집니다.
          </p>
          <h3 className="text-xl font-semibold text-brand-black mt-8 mb-3">총이자가 가장 적은 방식은 무엇인가요?</h3>
          <p className="text-brand-mid leading-relaxed mb-4">
            일반적인 원금 상환 대출에서는 원금균등이 총이자를 줄이기 쉽습니다. 다만 첫 달 납입액이
            커서 초기 예산을 함께 확인해야 합니다.
          </p>
          <h3 className="text-xl font-semibold text-brand-black mt-8 mb-3">만기일시상환은 왜 총이자가 커지나요?</h3>
          <p className="text-brand-mid leading-relaxed mb-4">
            기간 중 원금이 줄지 않기 때문입니다. 매월 같은 원금에 이자가 붙고, 원금은 만기까지
            남아 있어 전체 이자액이 커질 수 있습니다.
          </p>
          <h3 className="text-xl font-semibold text-brand-black mt-8 mb-3">계산 결과만 보고 대출 방식을 고르면 되나요?</h3>
          <p className="text-brand-mid leading-relaxed mb-4">
